...
function domloaded() {
  ...
  function movePiece(x_from, y_from, x_to, y_to) {
    ...
    if (moved) {
      ...
      if (rokade) {
        ...
        console.log("Before: "+pieceArray[x_to][rokadeFrom]);
        console.log("After: "+pieceArray[x_to][rokadeTo]);
        ...
        for (var name in pieceClassArray) {
          if (pieceClassArray[name].getNameFromPosition([rokadeFrom, x_to])) {
            pieceClassArray[name].movePiece([rokadeTo, x_to]);
            if (upgrade) {
      ...
      for (var name in pieceClassArray) {
        ...
        console.log(pieceClassArray[name].getAvailableMoves());
      }
  ...
  class Piece {
    ...
    movePiece(newPosition) {
      this.previousPositions[turn] = this.position;
